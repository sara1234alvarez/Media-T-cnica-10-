...
class HelloWorld {
  static void Main(string[]args){
    Console.WriteLine("digite si eres hombre o mujer ");
    ...
    if(genero == "hombre"){
        ...
        if (edad < 18)
           {
           Console.WriteLine("tus preferencias son: Figuras de acción, Caricaturas, Series TV");
           }
        ...
        if (genero == "mujer"){
            ...
            {
               Console.WriteLine("tus preferencias son: Muñecas, Maquillaje, Series TV");
            } 
            
           else
            {
                Console.WriteLine("preferencias son: Maquillaje, Series TV, Cine, filantropía");
            }
